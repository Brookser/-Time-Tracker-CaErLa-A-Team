...
2. Generate time entries for newly assigned employees from 5/27/2025 through 6/2/2025
...
# Employees already assigned to these projects
ALREADY_ASSIGNED = {
    'P19241': ['E004', 'E015', 'E016', 'E001', 'E9003', 'E012', 'E003', 'TEST01'],
    'P99006': ['E004', 'E015', 'E016', 'E001', 'E9003', 'E012', 'E003', 'TEST01'],
    'P13724': ['E012', 'TEST01'],
    'P99005': ['E012', 'TEST01'],
    'P27260': ['E9013', 'E013', 'E012', 'E011']
}
...
def generate_time_entries_for_date_range(assignments):
    """Generate time entries for assigned employees from 5/27/2025 through 6/2/2025."""
...
def display_time_entry_summary(time_entries):
    ...
    print(f"Date range: 2025-05-27 to 2025-06-02")
...
def main():
    ...
    print("EMPLOYEE ASSIGNMENT AND TIME ENTRY GENERATION (FIXED VERSION)")
    print("=" * 70)

    # Step 1: Select employees
    print("\n1. Selecting employees for assignment...")
    selected_employees = select_employees_for_assignment(10)  # Fixed number for testing
