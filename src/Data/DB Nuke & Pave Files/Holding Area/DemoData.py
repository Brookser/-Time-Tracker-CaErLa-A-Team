...
def populate_demo_data():
    ...
    try:
        ...
        time_entries = [
            ...
            #
            # 5/12/25 data set:
            ('DD6057', 'E004', '2025-05-12 11:53:00', '2025-05-12 13:35:00', 'Organic local groupware', 0, 'SD0001'),
            ('DD6058', 'E004', '2025-05-12 10:01:00', '2025-05-12 10:35:00', 'Managed optimizing contingency', 0, 'SD0002'),
            ('DD6059', 'E004', '2025-05-12 10:54:00', '2025-05-12 11:08:00', 'Mandatory contextually-based paradigm', 0, 'SD0005'),
            ('DD6060', 'E015', '2025-05-12 11:55:00', '2025-05-12 12:26:00', 'Cross-platform asynchronous open architecture', 0, 'SD0001'),
            ('DD6061', 'E015', '2025-05-12 11:14:00', '2025-05-12 12:09:00', 'Optimized systemic monitoring', 0, 'SD0004'),
            ('DD6062', 'E015', '2025-05-12 08:57:00', '2025-05-12 12:02:00', 'Sharable bifurcated analyzer', 0, 'P002'),
            ('DD6063', 'E015', '2025-05-12 10:11:00', '2025-05-12 11:58:00', 'Business-focused 5th generation software', 0, 'SD0007'),
            ('DD6064', 'E9001', '2025-05-12 11:27:00', '2025-05-12 12:39:00', 'User-friendly directional complexity', 0, 'SD0002'),
            ('DD6065', 'E9001', '2025-05-12 11:57:00', '2025-05-12 12:56:00', 'Future-proofed multi-tasking ability', 0, 'SD0005'),
            ('DD6066', 'E9001', '2025-05-12 10:52:00', '2025-05-12 11:35:00', 'Optional encompassing throughput', 0, 'SD0004'),
            ('DD6067', 'E9001', '2025-05-12 11:00:00', '2025-05-12 11:33:00', 'Function-based 24 hour Graphical User Interface', 0, 'P10007'),
            ('DD6068', 'E9003', '2025-05-12 10:03:00', '2025-05-12 13:14:00', 'Profit-focused zero administration complexity', 0, 'P10001'),
            ('DD6069', 'E9003', '2025-05-12 10:04:00', '2025-05-12 11:27:00', 'Multi-layered scalable benchmark', 0, 'SD0002'),
            ('DD6070', 'E9003', '2025-05-12 10:37:00', '2025-05-12 12:49:00', 'Realigned background extranet', 0, 'SD0005'),
            ('DD6071', 'E9003', '2025-05-12 10:39:00', '2025-05-12 12:18:00', 'Profit-focused hybrid flexibility', 0, 'P002'),
            ('DD6072', 'E9004', '2025-05-12 11:58:00', '2025-05-12 12:56:00', 'Multi-layered user-facing middleware', 0, 'SD0004'),
            ('DD6073', 'E9004', '2025-05-12 10:06:00', '2025-05-12 11:45:00', 'Reverse-engineered intangible intranet', 0, 'SD0005'),
            ('DD6074', 'E9004', '2025-05-12 11:48:00', '2025-05-12 13:17:00', 'Persistent coherent functionalities', 0, 'SD0007'),
            ('DD6075', 'E9004', '2025-05-12 10:12:00', '2025-05-12 12:07:00', 'Synchronized zero tolerance migration', 0, 'SD0001'),
            ('DD6076', 'E9005', '2025-05-12 09:53:00', '2025-05-12 11:52:00', 'Streamlined national toolset', 0, 'SD0001'),
            ('DD6077', 'E004', '2025-05-12 10:03:00', '2025-05-12 10:53:00', 'Cloned stable flexibility', 0, 'P002'),
            ('DD6078', 'E015', '2025-05-12 12:05:00', '2025-05-12 12:49:00', 'Fully-configurable directional access', 0, 'SD0002'),
            ('DD6079', 'E9001', '2025-05-12 10:16:00', '2025-05-12 11:39:00', 'Ameliorated system-worthy conglomeration', 0, 'SD0007'),
            ('DD6080', 'E9003', '2025-05-12 11:43:00', '2025-05-12 12:56:00', 'Distributed multimedia strategy', 0, 'P001'),
            ('DD6081', 'E9004', '2025-05-12 12:04:00', '2025-05-12 13:11:00', 'Future-proofed transitional archive', 0, 'P10001'),
            ('DD6082', 'E9006', '2025-05-12 10:19:00', '2025-05-12 10:37:00', 'Multi-lateral interactive process improvement', 0, 'P001'),
            ('DD6083', 'E004', '2025-05-12 10:31:00', '2025-05-12 12:14:00', 'Optimized bifurcated challenge', 0, 'SD0007'),
            ('DD6084', 'E004', '2025-05-12 10:06:00', '2025-05-12 12:07:00', 'Sharable asynchronous customer loyalty', 0, 'P001'),
            ('DD6085', 'E004', '2025-05-12 10:08:00', '2025-05-12 11:47:00', 'Team-oriented directional time-frame', 0, 'SD0001'),
            ('DD6086', 'E004', '2025-05-12 09:51:00', '2025-05-12 10:49:00', 'Multi-layered actuating internet service-desk', 0, 'SD0002'),
            ('DD6087', 'E004', '2025-05-12 10:06:00', '2025-05-12 10:20:00', 'Diverse content-based initiative', 0, 'SD0005'),
            ('DD6088', 'E015', '2025-05-12 11:08:00', '2025-05-12 12:09:00', 'Balanced 24 hour productivity', 0, 'SD0001'),
            ('DD6089', 'E015', '2025-05-12 12:03:00', '2025-05-12 12:58:00', 'Object-based web-enabled implementation', 0, 'SD0004'),
            ('DD6090', 'E015', '2025-05-12 10:34:00', '2025-05-12 12:39:00', 'Synergized leading edge alliance', 0, 'P002'),
            ('DD6091', 'E015', '2025-05-12 09:51:00', '2025-05-12 11:38:00', 'Re-engineered web-enabled productivity', 0, 'SD0007'),
            ('DD6092', 'E9001', '2025-05-12 11:34:00', '2025-05-12 12:46:00', 'Profound disintermediate synergy', 0, 'SD0002'),
            ('DD6093', 'E9001', '2025-05-12 11:54:00', '2025-05-12 13:13:00', 'Optional explicit intranet', 0, 'SD0005'),
            ('DD6094', 'E9001', '2025-05-12 09:59:00', '2025-05-12 10:42:00', 'Robust analyzing customer loyalty', 0, 'SD0004'),
            ('DD6095', 'E9001', '2025-05-12 10:04:00', '2025-05-12 11:33:00', 'Extended intangible interface', 0, 'P10007'),
            ('DD6096', 'E9003', '2025-05-12 12:03:00', '2025-05-12 13:14:00', 'Reduced radical strategy', 0, 'P10001'),
            ('DD6097', 'E9003', '2025-05-12 10:27:00', '2025-05-12 11:50:00', 'Decentralized stable flexibility', 0, 'SD0002'),
            ('DD6098', 'E9003', '2025-05-12 10:06:00', '2025-05-12 12:18:00', 'Sharable client-server open architecture', 0, 'SD0005'),
            ('DD6099', 'E9003', '2025-05-12 10:17:00', '2025-05-12 11:59:00', 'Managed full-range emulation', 0, 'P002'),
            ('DD6100', 'E9004', '2025-05-12 11:16:00', '2025-05-12 11:50:00', 'Progressive object-oriented portal', 0, 'SD0004'),
            ('DD6101', 'E9004', '2025-05-12 11:35:00', '2025-05-12 11:49:00', 'Centralized contextually-based portal', 0, 'SD0005'),
            ('DD6102', 'E9004', '2025-05-12 10:43:00', '2025-05-12 11:44:00', 'Digitized optimizing parallelism', 0, 'SD0007'),
            ('DD6103', 'E9004', '2025-05-12 11:43:00', '2025-05-12 12:38:00', 'Fundamental secondary customer loyalty', 0, 'SD0001'),
            ('DD6104', 'E9006', '2025-05-12 09:52:00', '2025-05-12 11:52:00', 'Down-sized actuating superstructure', 0, 'SD0004'),
            ('DD6105', 'E004', '2025-05-12 10:42:00', '2025-05-12 12:29:00', 'Organized motivating implementation', 0, 'P002'),
            ('DD6106', 'E015', '2025-05-12 10:45:00', '2025-05-12 11:57:00', 'Decentralized leading definition', 0, 'SD0006'),
            ('DD6107', 'E9001', '2025-05-12 09:57:00', '2025-05-12 11:16:00', 'Organized content-based focus group', 0, 'SD0007'),
            ('DD6108', 'E9003', '2025-05-12 11:17:00', '2025-05-12 12:20:00', 'Networked 3rd generation time-frame', 0, 'P001'),
            ('DD6109', 'E9004', '2025-05-12 10:24:00', '2025-05-12 10:57:00', 'Right-sized context-sensitive architecture', 0, 'P10001'),
            ('DD6110', 'E9006', '2025-05-12 11:07:00', '2025-05-12 12:18:00', 'Object-based demand-driven challenge', 0, 'P001'),
            ('DD6111', 'E004', '2025-05-12 11:31:00', '2025-05-12 12:54:00', 'Proactive fault-tolerant capacity', 0, 'SD0007'),
            ('DD6112', 'E004', '2025-05-12 10:04:00', '2025-05-12 12:16:00', 'Expanded value-added open architecture', 0, 'P001')
        ]
