...
-- Generated on: 2025-05-16 21:09:44
...
-- Table `employee_projects`: ~99 rows, Data: 0.02MB, Indexes: 0.03MB
-- Table `employee_table`: ~40 rows, Data: 0.02MB, Indexes: 0.05MB
-- Table `login_table`: ~40 rows, Data: 0.02MB, Indexes: 0.02MB
-- Table `projects`: ~78 rows, Data: 0.02MB, Indexes: 0.03MB
-- Table `time`: ~330 rows, Data: 0.06MB, Indexes: 0.06MB
